...
import { Tag, ChevronRight, Check, Gift, Truck, Percent } from "lucide-react";
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button
          variant="outline"
          className="w-full h-12 justify-between text-left font-normal border-dashed"
        >
          <div className="flex items-center gap-2">
            <Tag className="w-4 h-4 text-primary" />
            <span className="text-foreground">
              {selectedCoupon 
                ? `Applied: ${selectedCoupon.reward}`
      ...
      <SheetContent side="bottom" className="h-[80vh] overflow-y-auto">
        <SheetHeader>
          <SheetTitle className="text-xl font-bold">Available Offers</SheetTitle>
        </SheetHeader>
                      ...
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            On orders above ₹{tier.threshold}
                          </p>
                          {tier.value && (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-primary font-medium">
                        Add ₹{amountNeeded} more to unlock this offer
                      </p>
                    </div>
                  </div>
                );
