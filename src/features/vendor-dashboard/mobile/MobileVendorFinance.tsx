  ...
  return (
    <div className="px-4 py-5 space-y-6">
      <section>
        ...
        <div className="bg-[hsl(var(--vd-surface))] border border-[hsl(var(--vd-stroke))] rounded-3xl p-4 mt-3">
      ...
      <section className="space-y-3">
        <SectionTitle eyebrow="تسویه">برداشت‌ها</SectionTitle>
        <HeroBalanceCard
          balance={payouts.withdrawable}
          pending={payouts.pending}
          nextSettlement={payouts.nextSettlement}
      ...
      <section className="space-y-3">
        ...
        <Accordion type="multiple" defaultValue={["identity"]} className="space-y-2">
          ...
          >
            <AccordionTrigger className="text-sm font-semibold py-3 hover:no-underline">اطلاعات هویتی</AccordionTrigger>
          ...
          >
            ...
            <AccordionContent className="space-y-3 pb-4">
              ...
              <FormField label="شماره شبا" placeholder="IR" registerProps={bankForm.register("iban")} error={bankForm.formState.errors.iban?.message as string} />
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem
            ...
            className="bg-[hsl(var(--vd-surface))] border border-[hsl(var(--vd-stroke))] rounded-2xl px-4"
          >
            <AccordionTrigger className="text-sm font-semibold py-3 hover:no-underline">اطلاعات مالیاتی</AccordionTrigger>
            <AccordionContent className="space-y-3 pb-4">
              {merchantType === "individual" ? (
                <>
          ...
          <AccordionItem
            ...
            className="bg-[hsl(var(--vd-surface))] border border-[hsl(var(--vd-stroke))] rounded-2xl px-4"
          >
            <AccordionTrigger className="text-sm font-semibold py-3 hover:no-underline">قرارداد فروشنده</AccordionTrigger>
            <AccordionContent className="pb-4">
              <div className="flex items-center justify-between">
                <div className="text-xs text-muted-foreground">مطالعه و امضای قرارداد همکاری</div>
                <Button variant="outline" size="sm" className="rounded-full" onClick={() => toast.message("دانلود شد (نمایشی)")}>
